...
The Decision Lab (behavioral science consultancy, McGill University) works at exactly the intersection of intention-action gaps, organizational decision-making, and metric design — the human side of this experiment. Their existing measurement instruments for behavioral intention strength [@sheeran2002intention] could be adapted for the human baseline condition. The structural parallel between their work on closing the human intention-action gap and this work on characterizing the LLM inversion is the natural entry point for a conversation.
